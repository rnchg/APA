  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Audio.Denoise.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Audio.Denoise.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Audio.Denoise.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Audio.Denoise.OutputFolder')" prop="output">
          <el-input v-model="formModel.output" :placeholder="t('Audio.Denoise.OutputFolder')">
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Audio.Denoise.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Audio.Denoise.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Audio.Denoise.Mode')" prop="mode">
...
import API from "@/api/audio/denoise.api";
...
const modeOptions = [{ value: "standard", label: t("Audio.Denoise.ModeStandard") }];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Audio.Denoise.Help") });
});
