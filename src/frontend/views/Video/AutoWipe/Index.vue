  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Video.AutoWipe.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Video.AutoWipe.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Video.AutoWipe.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Video.AutoWipe.OutputFolder')" prop="output">
          <el-input v-model="formModel.output" :placeholder="t('Video.AutoWipe.OutputFolder')">
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Video.AutoWipe.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Video.AutoWipe.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Video.AutoWipe.Mode')" prop="mode">
    ...
    <el-row :gutter="10">
      ...
      <el-col :sm="12">
        <el-card class="mb-2">
          <FileView ref="fileViewRef" :maskVisible="true" :videoVisible="true" />
        </el-card>
      </el-col>
      <el-col :sm="6">
        <el-card>
...
import API from "@/api/video/autoWipe.api";
...
const modeOptions = [{ value: "standard", label: t("Video.AutoWipe.ModeStandard") }];
...
function handleStart() {
  ...
  formModel.mask = fileViewRef.value.getMask();
  handleBegin();
  API.start(
    formModel,
    (msg: any) => {
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Video.AutoWipe.Help") });
});
