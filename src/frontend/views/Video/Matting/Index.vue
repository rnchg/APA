  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Video.Matting.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Video.Matting.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Video.Matting.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Video.Matting.OutputFolder')" prop="output">
          <el-input v-model="formModel.output" :placeholder="t('Video.Matting.OutputFolder')">
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Video.Matting.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Video.Matting.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Video.Matting.Mode')" prop="mode">
...
import API from "@/api/video/matting.api";
...
const modeOptions = [{ value: "standard", label: t("Video.Matting.ModeStandard") }];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Video.Matting.Help") });
});
