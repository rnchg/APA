  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Video.Organization.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Video.Organization.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Video.Organization.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Video.Organization.OutputFolder')" prop="output">
          <el-input v-model="formModel.output" :placeholder="t('Video.Organization.OutputFolder')">
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Video.Organization.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Video.Organization.Client')" prop="scale">
            <el-select v-model="formModel.client" style="width: 200px">
              <el-option
    ...
    <el-row :gutter="10">
      ...
      <el-col :sm="12">
        <el-card class="mb-2">
          <FileView ref="fileViewRef" :videoVisible="videoVisible" :textVisible="textVisible" />
        </el-card>
      </el-col>
      <el-col :sm="6">
        <el-card>
...
import API from "@/api/video/organization.api";
...
const clientOptions = [
  { value: "windows", label: t("Video.Organization.ClientBilibiliWindows") },
  { value: "android", label: t("Video.Organization.ClientBilibiliAndroid") },
];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Video.Organization.Help") });
});
