  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Video.FrameInterpolation.InputFolder')" prop="input">
          <el-input
            v-model="formModel.input"
            :placeholder="t('Video.FrameInterpolation.InputFolder')"
          >
            <template #append>
              <el-button @click="handleInput">
                {{ t("Video.FrameInterpolation.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Video.FrameInterpolation.OutputFolder')" prop="output">
          <el-input
            v-model="formModel.output"
            :placeholder="t('Video.FrameInterpolation.OutputFolder')"
          >
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Video.FrameInterpolation.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Video.FrameInterpolation.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Video.FrameInterpolation.Mode')" prop="mode">
          ...
          <el-form-item :label="t('Video.FrameInterpolation.Scale')" prop="scale">
            <el-select v-model="formModel.scale" style="width: 200px">
              <el-option
...
import API from "@/api/video/frameInterpolation.api";
...
const modeOptions = [{ value: "standard", label: t("Video.FrameInterpolation.ModeStandard") }];
const scaleOptions = [
  { value: "x2", label: t("Video.FrameInterpolation.ScaleX2") },
  { value: "x4", label: t("Video.FrameInterpolation.ScaleX4") },
  { value: "x8", label: t("Video.FrameInterpolation.ScaleX8") },
];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Video.FrameInterpolation.Help") });
});
