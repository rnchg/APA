  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Video.SuperResolution.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Video.SuperResolution.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Video.SuperResolution.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Video.SuperResolution.OutputFolder')" prop="output">
          <el-input
            v-model="formModel.output"
            :placeholder="t('Video.SuperResolution.OutputFolder')"
          >
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Video.SuperResolution.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Video.SuperResolution.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Video.SuperResolution.Mode')" prop="mode">
          ...
          <el-form-item :label="t('Video.SuperResolution.Scale')" prop="scale">
...
import API from "@/api/video/superResolution.api";
...
const modeOptions = [{ value: "standard", label: t("Video.SuperResolution.ModeStandard") }];
const scaleOptions = [
  { value: "x2", label: t("Video.SuperResolution.ScaleX2") },
  { value: "x4", label: t("Video.SuperResolution.ScaleX4") },
];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Video.SuperResolution.Help") });
});
