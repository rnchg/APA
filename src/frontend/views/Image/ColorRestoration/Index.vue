  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Image.ColorRestoration.InputFolder')" prop="input">
          <el-input
        ...
        <el-form-item :label="t('Image.ColorRestoration.OutputFolder')" prop="output">
          <el-input
        ...
        <el-space wrap :size="20">
          <el-form-item :label="t('Image.ColorRestoration.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Image.ColorRestoration.Mode')" prop="mode">
          ...
          <el-form-item :label="t('Image.ColorRestoration.Quality')" prop="quality">
...
const modeOptions = [{ value: "standard", label: t("Image.ColorRestoration.ModeStandard") }];
const qualityOptions = [
  { value: "high", label: t("Image.ColorRestoration.QualityHigh") },
  { value: "medium", label: t("Image.ColorRestoration.QualityMedium") },
  { value: "low", label: t("Image.ColorRestoration.QualityLow") },
];
