  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Image.FrameInterpolation.InputFolder')" prop="input">
          <el-input
            v-model="formModel.input"
            :placeholder="t('Image.FrameInterpolation.InputFolder')"
          >
            <template #append>
              <el-button @click="handleInput">
                {{ t("Image.FrameInterpolation.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Image.FrameInterpolation.OutputFolder')" prop="output">
          <el-input
            v-model="formModel.output"
            :placeholder="t('Image.FrameInterpolation.OutputFolder')"
          >
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Image.FrameInterpolation.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Image.FrameInterpolation.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Image.FrameInterpolation.Mode')" prop="mode">
          ...
          <el-form-item :label="t('Image.FrameInterpolation.Scale')" prop="scale">
...
import API from "@/api/image/frameInterpolation.api";
...
const modeOptions = [{ value: "standard", label: t("Image.FrameInterpolation.ModeStandard") }];
const scaleOptions = [
  { value: "x2", label: t("Image.FrameInterpolation.ScaleX2") },
  { value: "x4", label: t("Image.FrameInterpolation.ScaleX4") },
  { value: "x8", label: t("Image.FrameInterpolation.ScaleX8") },
];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Image.FrameInterpolation.Help") });
});
