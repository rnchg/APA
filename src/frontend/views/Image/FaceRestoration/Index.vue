  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Image.FaceRestoration.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Image.FaceRestoration.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Image.FaceRestoration.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Image.FaceRestoration.OutputFolder')" prop="output">
          <el-input
            v-model="formModel.output"
            :placeholder="t('Image.FaceRestoration.OutputFolder')"
          >
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Image.FaceRestoration.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Image.FaceRestoration.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Image.FaceRestoration.Mode')" prop="mode">
...
const modeOptions = [{ value: "standard", label: t("Image.FaceRestoration.ModeStandard") }];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Image.FaceRestoration.Help") });
});
