  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Image.AutoWipe.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Image.AutoWipe.InputFolder')">
            <template #append>
              <el-button type="primary" @click="handleInput">
                {{ t("Image.AutoWipe.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Image.AutoWipe.OutputFolder')" prop="output">
          <el-input v-model="formModel.output" :placeholder="t('Image.AutoWipe.OutputFolder')">
            <template #append>
              <el-button type="primary" @click="handleOutput">
                {{ t("Image.AutoWipe.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Image.AutoWipe.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Image.AutoWipe.Mode')" prop="mode">
    ...
    <el-row :gutter="10">
      ...
      <el-col :sm="12">
        <el-card class="mb-2">
          <FileView ref="fileViewRef" :image-visible="true" :mask-visible="true" />
        </el-card>
      </el-col>
      <el-col :sm="6">
        <el-card>
...
import API from "@/api/image/autoWipe.api";
...
const modeOptions = [{ value: "standard", label: t("Image.AutoWipe.ModeStandard") }];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: MessageTypeEnum.Info, text: t("Image.AutoWipe.Help") });
});
