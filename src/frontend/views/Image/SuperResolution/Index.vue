  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Image.SuperResolution.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Image.SuperResolution.InputFolder')">
            <template #append>
              <el-button @click="handleInput">
                {{ t("Image.SuperResolution.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Image.SuperResolution.OutputFolder')" prop="output">
          <el-input
            v-model="formModel.output"
            :placeholder="t('Image.SuperResolution.OutputFolder')"
          >
            <template #append>
              <el-button @click="handleOutput">
                {{ t("Image.SuperResolution.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Image.SuperResolution.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Image.SuperResolution.Mode')" prop="mode">
          ...
          <el-form-item :label="t('Image.SuperResolution.Scale')" prop="scale">
...
const modeOptions = [{ value: "standard", label: t("Image.SuperResolution.ModeStandard") }];
const scaleOptions = [
  { value: "x2", label: t("Image.SuperResolution.ScaleX2") },
  { value: "x4", label: t("Image.SuperResolution.ScaleX4") },
];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: "info", text: t("Image.SuperResolution.Help") });
});
