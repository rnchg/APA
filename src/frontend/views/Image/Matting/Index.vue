  ...
  <div class="app-container">
    <el-card class="mb-2">
      <el-form ref="formRef" :model="formModel">
        <el-form-item :label="t('Image.Matting.InputFolder')" prop="input">
          <el-input v-model="formModel.input" :placeholder="t('Image.Matting.InputFolder')">
            <template #append>
              <el-button type="primary" @click="handleInput">
                {{ t("Image.Matting.InputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item :label="t('Image.Matting.OutputFolder')" prop="output">
          <el-input v-model="formModel.output" :placeholder="t('Image.Matting.OutputFolder')">
            <template #append>
              <el-button type="primary" @click="handleOutput">
                {{ t("Image.Matting.OutputSelect") }}
              </el-button>
            </template>
          </el-input>
        </el-form-item>
        <el-space wrap :size="20">
          <el-form-item :label="t('Image.Matting.Provider')" prop="provider">
          ...
          <el-form-item :label="t('Image.Matting.Mode')" prop="mode">
...
const modeOptions = [{ value: "standard", label: t("Image.Matting.ModeStandard") }];
...
onMounted(() => {
  ...
  fileMessageRef.value.addMessage({ type: MessageTypeEnum.Info, text: t("Image.Matting.Help") });
});
